...
<body>
    ...
    <div class="section">
        ...
        <div class="figure">
            <img src="output/fig1_normalized_prices.png" alt="归一化收盘价走势图">
        </div>

        <h3>图2：日收益率分布图</h3>
        <p>10只股票收益率分面直方图，叠加正态分布曲线，标注均值和标准差。</p>
        <div class="figure">
            <img src="output/fig2_return_distributions.png" alt="日收益率分布图">
        </div>

        <h3>图3：收益率相关系数热力图</h3>
        <p>10只股票日收益率的相关系数矩阵，按行业排序。</p>
        <div class="figure">
            <img src="output/fig3_correlation_heatmap.png" alt="收益率相关系数热力图">
        </div>

        <h3>图4：宏观指标与股市关系</h3>
        <p>CPI与沪深300月度收益率散点图，叠加线性拟合线，标注Pearson相关系数。</p>
        <div class="figure">
            <img src="output/fig4_macro_stock_relation.png" alt="宏观指标与股市关系">
        </div>
    </div>
    ...
    <div class="section">
        ...
        <p style="text-align: center; font-size: 1.2em;">$r_{i,t} - r_f = \alpha_i + \beta_i (r_{m,t} - r_f) + \varepsilon_{i,t}$</p>

        <div class="figure">
            <img src="output/fig5_capm_betas.png" alt="CAPM Beta系数">
        </div>
...
print("注意：完整的图表需要运行03_analysis.ipynb后才能显示。")
